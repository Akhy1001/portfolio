      ...
      <div className="container flex items-center justify-between">
        ...
        <a href="#hero" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-[11px] text-gray-400 font-mono hidden sm:inline-block">Web & Mobile React</span>
          </div>
        </a>

        {/* Desktop Nav Links */}
        <nav className="hidden md:flex items-center gap-1 glass-card px-4 py-2 rounded-full border border-white/10">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
        ...
        <div className="hidden lg:flex items-center gap-4">
          {/* Theme Color Picker */}
          <div className="flex items-center gap-1.5 glass-card px-3 py-1.5 rounded-full border border-white/10" title="Changer la couleur d'accent">
